...
./gradlew :oboe-wrapper:publishReleasePublicationToMavenLocal \
  -PoboeRust.version=0.1.0-alpha.6
```
...
GitHub Release is published. Use release tags such as `v0.1.0-alpha.6`; the
workflow strips the leading `v` and publishes package version `0.1.0-alpha.6`.
