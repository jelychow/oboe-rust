...
require_file "android/oboe-wrapper/openai-realtime-app/build.gradle"
require_file "android/oboe-wrapper/openai-realtime-app/multidex-keep.txt"
require_file "android/oboe-wrapper/openai-realtime-app/multidex-keep.pro"
...
require_pattern "android/oboe-wrapper/openai-realtime-app/build.gradle" 'oboeRust\.realtimeDependency'
require_pattern "android/oboe-wrapper/openai-realtime-app/build.gradle" "project\\(':oboe-wrapper'\\)"
require_pattern "android/oboe-wrapper/openai-realtime-app/build.gradle" 'io\.github\.jelychow\.oboe:oboe-rust-android'
require_pattern "android/oboe-wrapper/openai-realtime-app/build.gradle" 'multiDexKeepFile'
require_pattern "android/oboe-wrapper/openai-realtime-app/build.gradle" 'multiDexKeepProguard'
require_pattern "android/oboe-wrapper/openai-realtime-app/multidex-keep.txt" 'com/example/openairustrealtime/MainActivity\.class'
require_pattern "android/oboe-wrapper/openai-realtime-app/multidex-keep.pro" 'com\.example\.openairustrealtime\.\*\*'
