...
class MainActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        apiKeyInput.setText(stateHolder.savedApiKey())
    ...
    private fun setupPanel(): View {
        return panel().apply {
            ...
            saveKeyButton = primaryButton("Save")
    ...
    private fun realtimePanel(): LinearLayout {
        return panel().apply {
            ...
            stopRealtimeButton.setOnClickListener { stateHolder.stopRealtime() }
    ...
    private fun translatePanel(): LinearLayout {
        return panel().apply {
            ...
            stopTranslateButton.setOnClickListener { stateHolder.stopRealtime() }
