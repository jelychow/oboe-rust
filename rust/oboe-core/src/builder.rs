...
impl Default for StreamBuilder {
    fn default() -> Self {
        Self {
            ...
            input_preset: InputPreset::Unspecified,
...
mod tests {
    ...
    #[test]
    fn builder_accepts_voice_communication_input_session_settings() {
        let builder = StreamBuilder {
            direction: Direction::Input,
            input_preset: InputPreset::VoiceCommunication,
            session_id: 0,
            ..StreamBuilder::default()
        };
    ...
    #[test]
    fn builder_accepts_voice_communication_output_attributes() {
        let builder = StreamBuilder {
            direction: Direction::Output,
            usage: Usage::VoiceCommunication,
    ...
    #[test]
    fn builder_rejects_invalid_session_id() {
        let builder = StreamBuilder {
            session_id: -2,
            ..StreamBuilder::default()
        };
