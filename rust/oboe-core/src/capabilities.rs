...
pub const CAPABILITIES: &[Capability] = &[
    ...
    Capability {
        ...
        support: SupportLevel::Partial,
        note: "AAudio input preset, output usage, output content type, and session id are available; device id, capture policy, privacy, spatialization, package name, attribution tag, and conversion policy are not available.",
    },
];
